...
public class DEXConvertOrbPower extends BasePower {
    public static final String POWER_ID = makeID("DEXConvertOrb");
    ...
    public DEXConvertOrbPower(AbstractPlayer owner, int magicNumber) {
