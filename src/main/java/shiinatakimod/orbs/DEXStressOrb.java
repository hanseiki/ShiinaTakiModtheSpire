...
public class DEXStressOrb
        extends ShiinaTakiOrb{
    public static final String ID = ShiinaTakiBasicMod.makeID("DEXStressOrb");
    ...
    public DEXStressOrb(int passiveAmount, int evokeAmount){
        super(
    ...
    public void onCount(){//计数器触发时，弃1张牌，下回合减evokeAmount抽牌
        ...
        AbstractDungeon.actionManager.addToBottom(
                new ConvertOrbAction(
                        DEXStressOrb.class, FutsuStressOrb.class,
