...
public class TestGainPowerc extends BaseCard {
    public static final String ID = makeID(TestGainPowerc.class.getSimpleName());
 ...
 //Sets the card's damage and how much it changes when upgraded.
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(
                new ApplyPowerAction(p,p,new DrawNextTurnPower(p,magicNumber,3),magicNumber
                )
        );
    }
}