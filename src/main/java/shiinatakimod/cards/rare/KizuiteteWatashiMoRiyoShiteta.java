...
import shiinatakimod.actions.KizuiteteWatashiMoRiyoShitetaAction;
...
//我注意到这一点 也利用了你
// 気づいてて　私も利用してた
public class KizuiteteWatashiMoRiyoShiteta
        extends BaseCard {
    public static final String ID = makeID(KizuiteteWatashiMoRiyoShiteta.class.getSimpleName());
    ...
    public KizuiteteWatashiMoRiyoShiteta() {
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        AbstractDungeon.actionManager.addToBottom(new KizuiteteWatashiMoRiyoShitetaAction(p, m,this.magicNumber));
    }
}
