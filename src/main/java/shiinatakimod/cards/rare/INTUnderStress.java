...
public class INTUnderStress
        extends BaseCard {
    public static final String ID = makeID(INTUnderStress.class.getSimpleName());
    ...
    public INTUnderStress() {
        super(ID, info); //Pass the required information to the BaseCard constructor.

        setMagic(INT); //Sets the card's damage and how much it changes when upgraded.
